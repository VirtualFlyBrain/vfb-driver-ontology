 ...
 * [VFB_drivers.yml](VFB_drivers.yml)
     * Determines how your purl.obolibrary.org/obo/VFB_drivers/ redirects will be handled
     ...
     * Paste in the contents of [VFB_drivers.yml](VFB_drivers.yml)
 ...
 * [VFB_drivers.md](VFB_drivers.md)
     ...
     * Paste in the contents of [VFB_drivers.md](VFB_drivers.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
