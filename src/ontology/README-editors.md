...
Make sure you have an ID range in the [idranges file](VFB_drivers-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [VFB_drivers-edit.owl](VFB_drivers-edit.owl)

** DO NOT EDIT VFB_drivers.obo OR VFB_drivers.owl in the top level directory **

[../../VFB_drivers.owl](../../VFB_drivers.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/VirtualFlyBrain/vfb-driver-ontology) for details.
 ...
 * [VFB_drivers-idranges.owl](VFB_drivers-idranges.owl)
...
This generates derived files such as VFB_drivers.owl and VFB_drivers.obo and places
 ...
 * https://github.com/VirtualFlyBrain/vfb-driver-ontology/releases
...
what is in the `owl:versionIRI` of the derived VFB_drivers.owl (`data-version` in
VFB_drivers.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/VFB_drivers.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/VFB_drivers/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/VirtualFlyBrain/vfb-driver-ontology.svg?branch=master)](https://travis-ci.org/VirtualFlyBrain/vfb-driver-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/VirtualFlyBrain](https://travis-ci.org/profile/VirtualFlyBrain)
 2. click the "Sync account" button
 3. Click the tick symbol next to vfb-driver-ontology
